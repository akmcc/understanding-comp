...
class DPADesign < Struct.new(:start_state, :bottom_character, :accept_states, :rulebook)
...
rulebook = DPDARulebook.new([PDARule.new(1, '(', 2, '$', ['b', '$']), PDARule.new(2, '(', 2, 'b', ['b', 'b']), PDARule.new(2, ')', 2, 'b', []), PDARule.new(2, nil, 1, '$', ['$'])])
